#!/usr/bin/env python3
"""
de_interwiki_wikidata_sync_bot.py  –  append Wikidata-derived interwiki blocks
-------------------------------------------------------------------------
For every page supplied in *pages.txt* this bot:
  1. Scans the pageʼs wikitext for the **first** {{de:…}}, {{de:…}},
...
# ─── REGEXES ──────────────────────────────────────────────────────────
IW_RE = re.compile(r"\[\[\s*(de|de|zh|en)\s*:\s*([^\]|]+)")
