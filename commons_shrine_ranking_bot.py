#!/usr/bin/env python
"""
Wikimedia Commons Bot - Add Shrine Ranking Categories Based on Wikidata
========================================================================

For categories under Category:Shinto shrines by ranking:
1. Get the Wikidata item for the Commons category
2. Get the category's main topic (P301)
3. Find all items where property = P301 value
4. Get their Commons categories (P373)
5. Add the category to those Commons category pages

Property types:
- P31 (instance of) - most categories
- P13723 (modern shrine ranking) - for Modern system categories
- P149 (architectural style) - for architecture categories
- P361 (part of) - for Shikinaisha by Province categories
"""
...
# Format: (category_name, property_type)
CATEGORIES = [
    # P31 categories
    ("Beppyo Shrines", "P31"),
    ("Chokusaisha", "P31"),
...
def main():
    print("="*70)
    print("WIKIMEDIA COMMONS - SHRINE RANKING CATEGORIES BOT")
    print("="*70)
    print()
