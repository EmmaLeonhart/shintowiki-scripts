# Stuck katakana `P1814` readings — 2026-09-16
...
Emma, 2026-09-13, given the choice between relocating these readings onto the ojp-hani official name and deleting them: *"Move it, then delete."*

`generate_kana_qualifier_add.py`'s second pass was widened that day to do it — it had been gated on the name carrying no `P1814` qualifier at all, which is the whole reason anything here was stuck. Every row below now has `<reading>カミノヤシロ` staged onto its name in `kana_qualifier_add.txt`, and `generate_kana_qualifier_remove.py` retires the top-level once a fresh SPARQL query confirms that exact value landed. **So the numbers here should fall on their own**; a category that stops shrinking is the thing to look at, not a category that is large.
...
**733 top-level katakana statements** on shrines carrying an ojp-hani official name.

## Summary

| n | reading preserved? | item has hiragana? | shape |
|---:|---|---|---|
| 309 | name carries no reading at all | no | fragment, tail cut off |
| 89 | name carries no reading at all | no | fragment, head cut off |
| 67 | name carries a reading, but unconfirmed (no カミノヤシロ) | no | fragment, tail cut off |
| 56 | removable by the pipeline today | no | fragment, tail cut off |
...
### 309 — name carries no reading at all; hiragana absent; fragment, tail cut off
...
### 89 — name carries no reading at all; hiragana absent; fragment, head cut off
...
### 67 — name carries a reading, but unconfirmed (no カミノヤシロ); hiragana absent; fragment, tail cut off
...
### 56 — removable by the pipeline today; hiragana absent; fragment, tail cut off
...
| [Q135038997](https://www.wikidata.org/wiki/Q135038997) | 白山神社 (桜井市) | `ウタヨリノ-` | `ウタヨリノ-カミノヤシロ` |
...
| [Q135039676](https://www.wikidata.org/wiki/Q135039676) | 阿米都瀬気多知命神社 | `アメツセノ-` | `アメツセノ-カミノヤシロ` |
...
| [Q135041278](https://www.wikidata.org/wiki/Q135041278) | 麻為比売神社 | `マヰ-` | `マヰ-カミノヤシロ` |
...
| [Q135070106](https://www.wikidata.org/wiki/Q135070106) | 嘉羅久利神社 | `-サクタノ` | `-サクタノカミノヤシロ` |
