# Stuck katakana `P1814` readings — 2026-09-21
...
**721 top-level katakana statements** on shrines carrying an ojp-hani official name.

## Summary

| n | reading preserved? | item has hiragana? | shape |
|---:|---|---|---|
| 302 | name carries no reading at all | no | fragment, tail cut off |
...
| 59 | removable by the pipeline today | no | fragment, tail cut off |
...
### 302 — name carries no reading at all; hiragana absent; fragment, tail cut off
...
### 59 — removable by the pipeline today; hiragana absent; fragment, tail cut off
