# Stuck katakana `P1814` readings — 2026-09-15
...
**734 top-level katakana statements** on shrines carrying an ojp-hani official name.

## Summary

| n | reading preserved? | item has hiragana? | shape |
|---:|---|---|---|
| 311 | name carries no reading at all | no | fragment, tail cut off |
| 90 | name carries no reading at all | no | fragment, head cut off |
| 67 | name carries a reading, but unconfirmed (no カミノヤシロ) | no | fragment, tail cut off |
| 55 | removable by the pipeline today | no | fragment, tail cut off |
...
### 311 — name carries no reading at all; hiragana absent; fragment, tail cut off
...
### 90 — name carries no reading at all; hiragana absent; fragment, head cut off
...
### 55 — removable by the pipeline today; hiragana absent; fragment, tail cut off
