# Stuck katakana `P1814` readings — 2026-09-20
...
**725 top-level katakana statements** on shrines carrying an ojp-hani official name.

## Summary

| n | reading preserved? | item has hiragana? | shape |
|---:|---|---|---|
| 303 | name carries no reading at all | no | fragment, tail cut off |
...
| 57 | removable by the pipeline today | no | fragment, tail cut off |
...
### 303 — name carries no reading at all; hiragana absent; fragment, tail cut off
...
### 57 — removable by the pipeline today; hiragana absent; fragment, tail cut off
...
| [Q135040620](https://www.wikidata.org/wiki/Q135040620) | 佐伎都比古阿流知命神社 | `サキツヒコ-` | `サキツヒコ-カミノヤシロ` |
