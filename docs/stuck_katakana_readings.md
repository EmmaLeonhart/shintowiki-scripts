# Stuck katakana `P1814` readings — 2026-09-17
...
**730 top-level katakana statements** on shrines carrying an ojp-hani official name.

## Summary

| n | reading preserved? | item has hiragana? | shape |
|---:|---|---|---|
| 307 | name carries no reading at all | no | fragment, tail cut off |
...
### 307 — name carries no reading at all; hiragana absent; fragment, tail cut off
