#!/usr/bin/env python3
"""generate_shikinaisha_pages_v14.py
================================================
Generate standardized shrine pages for Wikidata-generated Shikinaisha entries
V14: Include source URLs in references, omit P2671
================================================
...
def format_wikidata_link(entity, qid):
    ...
    if not entity:
        return f"{{{{ill|{qid}|{qid}}}}}"

    english_label = get_label(entity, 'en')
    japanese_label = get_label(entity, 'ja')
    ...
    if japanese_label:
        template += f"|ja={japanese_label}"

    # Add additional language labels if available
    for lang in ['de', 'fr', 'es', 'it', 'pt', 'ru', 'zh']:
...
def format_page_content(page_name, qid, entity):
    ...
    final_content = "<!--generated by generate_shikinaisha_pages_v14.py-->\n" + "\n".join(content_parts)
...
def main():
    ...
    print("Generating standardized Shikinaisha pages (V14 - Include source URLs, omit P2671)\n")
    print("=" * 60)
    ...
    for idx, page in enumerate(members, 1):
        try:
            ...
            # Save the page
            try:
                page.edit(new_content, summary="Bot: Generate standardized Shikinaisha page (V14 - include source URLs, omit P2671)")
                processed_count += 1
                print(f" ... ✓ Updated")
