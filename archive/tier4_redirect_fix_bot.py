#!/usr/bin/env python3
"""
tier4_redirect_fix_bot.py
=========================
• Scans **Tier 4 Categories with no enwiki** for redirect‑categories.
...
SRC_CAT   = "Category:Tier 4 Categories with no enwiki"
THROTTLE  = 0.4
...
def main():
    site = get_site()
    print("Logged in – scanning redirect Tier‑4 cats…")
