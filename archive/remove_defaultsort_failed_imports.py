#!/usr/bin/env python3
"""
Remove DEFAULTSORT and デフォルトソート templates from Category:Failed imports
"""
...
def main():
    print("=" * 80)
    print("REMOVE DEFAULTSORT TEMPLATES FROM FAILED IMPORTS")
    print("=" * 80)
    print()
    ...
    for i, page in enumerate(pages, 1):
        ...
        if text != original_text:
            # Save the changes
            page.save(text, summary='Bot: Remove DEFAULTSORT and デフォルトソート templates')
