#!/usr/bin/env python3
"""
add_dummy_category_categories.py
================================
Adds [[Category:Categories]] to the end of every page in the category namespace.
...
CATEGORY_TO_ADD = "[[Category:Categories]]"
...
def main():
    ...
    print("Processing all pages in Category namespace (ns=14)...")
    ...
    for page in site.allpages(namespace=14):
        ...
        try:
            ...
            if "[[Category:Categories]]" in content:
