...
echo [1/8] Generating Toki Pona labels...
...
echo [2/8] Generating Korean labels...
...
echo [3/8] Generating Chinese labels...
...
echo [4/8] Generating tr/de/nl/es/it/eu/lt/ru/uk/fa/ar labels...
...
echo [5/8] Generating Shikinaisha-list labels (Engishiki Jinmyocho + 69 province lists)...
...
echo [6/8] Generating kami (deity) labels...
...
echo [7/8] Generating shrine-rank labels...
...
echo [8/8] Generating province labels...
