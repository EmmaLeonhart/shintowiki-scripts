...
COVERED = {
    ...
    "mad": ("generate_multilang_quickstatements.py", "madurese (Latin, affix-only like jv)"),
    "my": ("generate_multilang_quickstatements.py", "burmese (Aksharamukha Devanagari→Burmese)"),
    "km": ("generate_multilang_quickstatements.py", "khmer (Aksharamukha)"),
    "lo": ("generate_multilang_quickstatements.py", "lao (Aksharamukha)"),
    "dz": ("generate_multilang_quickstatements.py", "dzongkha/Tibetan (Aksharamukha)"),
    "shn": ("generate_multilang_quickstatements.py", "shan (Aksharamukha)"),
    ...
    "he": ("generate_multilang_quickstatements.py", "hebrew"),
