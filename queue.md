...
- [ ] **`Oyama Otsu Shrine` is two articles in one page** (Oyama Otsu Shrine + Ozu Shrine).
  Opened in Emma's browser 2026-07-09 for a hand split; `Ozu Shrine (Moriyama).wiki` already exists
  separately. (`Mifune Shrine (Taki)` is DONE — it was *three* concatenated articles, not two:
  one unprocessed old-style copy plus two identical merged copies; rebuilt to the Tamatsukuri shape,
  33,147 → 11,591 bytes.)
