...
<!-- WIKI_GATE: WAIT -->
**Status: ⏸ WAITING** (Miraheze 403, checked 2026-07-12 21:09 UTC) — wiki editing is blocked. The hourly `wiki-editing-gate.yml` CI job runs `check_wiki_login.py` and flips the marker above to **`WIKI_GATE: GO`** the moment the login works again.
