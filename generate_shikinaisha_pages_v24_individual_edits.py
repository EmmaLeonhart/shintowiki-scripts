#!/usr/bin/env python3
"""generate_shikinaisha_pages_v24_individual_edits.py
================================================
V24: Individual page edits approach
Uses the same page generation logic as v23, but edits pages individually (like v19)
This is slower but more reliable and doesn't require bulk XML uploads

To verify output matches v24_local_storage.py, compare the generated page content
"""
...
# ═══ SHARED HELPER FUNCTIONS (same as v23) ═══
...
def format_page_content(page_name, qid, entity):
    ...
    final_content = "<!--generated by generate_shikinaisha_pages_v24_individual_edits.py-->\n" + "\n".join(content_parts)
    return final_content

# ═══ MAIN PROCESS ═══

def main():
    print("Generating standardized Shikinaisha pages (V24 - Individual edits)\n")
    print("=" * 60)
    ...
    for i, page in enumerate(members, 1):
        ...
        try:
            ...
            # Edit the page
            page.edit(new_content, summary="v24 individual edit: Standardize page format")
            print(f" ... ✓ Edited")
            processed_count += 1
