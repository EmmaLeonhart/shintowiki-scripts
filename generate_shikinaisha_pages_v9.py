...
def format_claim_value(claim, entity, property_id=None):
    ...
    if property_id == 'P13677' and isinstance(value, str):
        ...
        return f"[{url} Kokugakuin Digital Museum Item]"
...
def format_page_content(page_name, qid, entity):
    ...
    for prop_id in property_order:
        if prop_id in all_claims:
            ...
            for claim in claims:
                formatted_value = format_claim_value(claim, entity, prop_id)
                if formatted_value:
    ...
    final_content = "<!--generated by generate_shikinaisha_pages_v9.py-->\n" + "\n".join(content_parts)
...
def main():
    ...
    for idx, page in enumerate(members, 1):
        try:
            ...
            # Save the page
            try:
                page.edit(new_content, summary="Bot: Generate standardized Shikinaisha page (V8 - proper ILL deity links, P13677 URLs, province extraction)")
                processed_count += 1
                print(f" ... ✓ Updated")
