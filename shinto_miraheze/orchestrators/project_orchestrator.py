...
=======================
Cycles through every page in the Project namespace (ns=4, "Shinto Wiki:").
Subject-side sweep only.

State file: project_orchestrator.state.
"""
...
def main():
    parser = argparse.ArgumentParser(description="Project-namespace cleanup orchestrator.")
    ...
    common.run_orchestrator(
        ...
        ns_label="project",
        ops=OPS,
        state_name="project_orchestrator",
        apply=args.apply,
