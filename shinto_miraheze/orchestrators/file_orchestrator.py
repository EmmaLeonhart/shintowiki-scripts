...
====================
Cycles through every page in the File namespace (ns=6). Subject-side
sweep only.

State file: file_orchestrator.state.
"""
...
def main():
    parser = argparse.ArgumentParser(description="File-namespace cleanup orchestrator.")
