#!/usr/bin/env python3
"""
recover_overwritten_pages.py
============================
Recover accidentally overwritten pages from edit history.

For each page in [[Category:Accidentally overwritten pages]]:
1. Check edit history
...
# Get the category
category = site.pages['Category:Accidentally overwritten pages']

print("Fetching pages in [[Category:Accidentally overwritten pages]]...")
try:
...
for i, page in enumerate(members, 1):
    try:
        ...
        revisions = list(page.revisions(dir='older', limit=100))
