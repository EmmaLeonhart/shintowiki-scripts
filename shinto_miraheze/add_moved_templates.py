...
MOVES = [
    ...
    # Feb 6, 2026
    ("Template/The 17 Generations of Deities", "Generations"),
    # Feb 15, 2026
    ("Category:17 spirits of the world", "Category:Seventeen Generations of Earthly Deities"),
    ("Template/The 17 Generations of Deities", "Template/Seventeen Generations of Earthly Deities"),
    ("The 17 Generations of Deities", "Seventeen Generations of Earthly Deities"),
    ("Template:The 17 Generations of Deities", "Template:Seventeen Generations of Earthly Deities"),
    # Feb 16, 2026
    ("Miyajima", "Miyajima (disambiguation)"),
    # Feb 17, 2026
    ("Isekurumano Shrine", "Ise-Kuruma Shrine"),
    ("Q135041284", "Q128866991"),
    ("Abo Shrine (Moto\u2011Abo)", "Abo Shrine (Moto-Abo)"),
    ("Ame\u2011no\u2011Morohano\u2011Mikoto Shrine", "Ame-no-Morohano-Mikoto Shrine"),
    ("Ame\u2011no\u2011Morohano\u2011Mikoto Shrine (Q135198847)", "Ame-no-Morohano-Mikoto Shrine (Q135198847)"),
    ("Ame\u2011no\u2011Morohano\u2011Mikoto Shrine (Q135198837)", "Ame-no-Morohano-Mikoto Shrine (Q135198837)"),
    ("Hachiman\u2011sha", "Hachiman-sha"),
    ("Hachiman\u2011sha (Q135070047)", "Hachiman-sha (Q135070047)"),
    ("Hachiman\u2011gu Kinomiya Shrine", "Hachiman-gu Kinomiya Shrine"),
    ("Yama\u2011no\u2011Kami Shrine", "Yama-no-Kami Shrine"),
    ("Yama\u2011no\u2011Kami Shrine (Q135069437)", "Yama-no-Kami Shrine (Q135069437)"),
    ("Yama\u2011no\u2011Kami Shrine (Teragaya, Nijō, Minamiizu Town, Shizuoka Prefecture)", "Yama-no-Kami Shrine (Teragaya, Nijō, Minamiizu Town, Shizuoka Prefecture)"),
    ("Category:Former Gō\u2011sha", "Category:Former Gō-sha"),
    ("Ōasa\u2011mato no Azato Tenjin Shrine", "Ōasa-mato no Azato Tenjin Shrine"),
    ("Shiratori Shrine (Shin\u2011Kami Goto Town)", "Shiratori Shrine (Shin-Kami Goto Town)"),
    ("Yahashira Shrine (Yotsuhikida, Kanki\u2011ji precincts)", "Yahashira Shrine (Yotsuhikida, Kanki-ji precincts)"),
    ("Uchino Shinmei\u2011gū", "Uchino Shinmei-gū"),
    ("Sae\u2011no\u2011Kami Shrine", "Sae-no-Kami Shrine"),
    ("Toriya\u2011zaki Shrine", "Toriya-zaki Shrine"),
    ("Sami\u2011no\u2011Hyōzu Shrine", "Sami-no-Hyōzu Shrine"),
    ("Takamori Shrine Oku\u2011sha", "Takamori Shrine Oku-sha"),
    ("Rikyū\u2011in Site", "Rikyū-in Site"),
    ("Okutsu\u2011Hime Shrine (Ama Town)", "Okutsu-Hime Shrine (Ama Town)"),
    ("Okutsu\u2011Hime Shrine (Hōsu Town)", "Okutsu-Hime Shrine (Hōsu Town)"),
    ("Narukami Kamo Myojin Shrine (in Tsuru\u2011ga\u2011mine Hachiman Shrine precinct)", "Narukami Kamo Myojin Shrine (in Tsuru-ga-mine Hachiman Shrine precinct)"),
    ("Naramoto Shrine (Miyamaru\u2011machi, Hakusan City)", "Naramoto Shrine (Miyamaru-machi, Hakusan City)"),
    ("Nanako\u2011no\u2011miya Shrine (within Kisaki Shrine precincts)", "Nanako-no-miya Shrine (within Kisaki Shrine precincts)"),
    ("Morooka\u2011Hiko Shrine (Higashi Komuro, Shiga Town)", "Morooka-Hiko Shrine (Higashi Komuro, Shiga Town)"),
    ("Nanako\u2011no\u2011Miya Shrine", "Nanako-no-Miya Shrine"),
    ("Morita\u2011no Shrine", "Morita-no Shrine"),
    ("Morooka Hiko Shrine (Nisho\u2011miya, Shiga Town)", "Morooka Hiko Shrine (Nisho-miya, Shiga Town)"),
    ("Million\u2011year house", "Million-year house"),
    ("Mitsuchino Shrine Oku\u2011no\u2011Miya", "Mitsuchino Shrine Oku-no-Miya"),
    ("Kurohime Shrine (Sato\u2011miya, Takayanagi Town, Kashiwazaki City)", "Kurohime Shrine (Sato-miya, Takayanagi Town, Kashiwazaki City)"),
    ("Mitsuchino Shrine Kado\u2011no\u2011Miya", "Mitsuchino Shrine Kado-no-Miya"),
    ("Komaki Sukune\u2011no\u2011Mikoto Shrine", "Komaki Sukune-no-Mikoto Shrine"),
    ("Komagatane Shrine Take\u2011no\u2011miya", "Komagatane Shrine Take-no-miya"),
    ("Komai Sukune\u2011no\u2011Mikoto Shrine", "Komai Sukune-no-Mikoto Shrine"),
    ("Amehikage\u2011Hime Shrine (Ninomiya, Nakanoto Town)", "Amehikage-Hime Shrine (Ninomiya, Nakanoto Town)"),
    ("Izumo\u2011no\u2011Ihahi Shrine (Itai, Kumagaya City)", "Izumo-no-Ihahi Shrine (Itai, Kumagaya City)"),
    ("Kiri\u2011hara Shrine", "Kiri-hara Shrine"),
    ("Inano\u2011Hime Shrine", "Inano-Hime Shrine"),
    ("Achie\u2011nobe Shrine", "Achie-nobe Shrine"),
    ("Gama Shinmei\u2011gū", "Gama Shinmei-gū"),
    ("Ihinoyama Shrine (Miyashita\u2011kita)", "Ihinoyama Shrine (Miyashita-kita)"),
    ("Ikatsuchi\u2011no\u2011Mikoto Shrine", "Ikatsuchi-no-Mikoto Shrine"),
    ("Iwatani\u2011mon Shrine", "Iwatani-mon Shrine"),
    ("Izumo\u2011no\u2011Ihahi Shrine (Yorii Town, Ōsato District)", "Izumo-no-Ihahi Shrine (Yorii Town, Ōsato District)"),
    ("Amano\u2011Kaguyama Shrine", "Amano-Kaguyama Shrine"),
    ("Kamazoku\u2011Miden Shrine", "Kamazoku-Miden Shrine"),
    ("Izumo no Kuni Fudoki", "Izumo-no-Kuni Fudoki"),
]
