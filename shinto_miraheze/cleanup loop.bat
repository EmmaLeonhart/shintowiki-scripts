...
echo Launching cleanup loop from: %WIKIBOT_DIR%
echo.
...
start "fix_erroneous_qid_category_links" /D "%WIKIBOT_DIR%" cmd /k "python shinto_miraheze\fix_erroneous_qid_category_links.py --apply"

echo Opened 5 command windows.
