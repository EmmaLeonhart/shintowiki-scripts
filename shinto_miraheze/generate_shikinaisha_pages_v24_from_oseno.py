#!/usr/bin/env python3
"""generate_shikinaisha_pages_v24_from_oseno.py
================================================
V24: Individual page edits approach, continuing from Minakuchino Shrine
Uses the exact same page generation logic as v24_individual_edits.py
Skips all pages alphabetically before Minakuchino Shrine, then edits continuously
"""
...
def format_page_content(page_name, qid, entity):
    ...
    final_content = "<!--generated by generate_shikinaisha_pages_v24_from_oseno.py-->\n" + "\n".join(content_parts)
    return final_content

# ═══ MAIN PROCESS ═══

def main():
    print("Generating standardized Shikinaisha pages (V24 - Continuing from Minakuchino Shrine)\n")
    print("=" * 60)
    ...
    for i, page in enumerate(members, 1):
        ...
        try:
            ...
            # Edit the page
            page.edit(new_content, summary="v24 from Oseno: Standardize page format (continuing from Minakuchino Shrine)")
            print(f" ... ✓ Edited")
            processed_count += 1
