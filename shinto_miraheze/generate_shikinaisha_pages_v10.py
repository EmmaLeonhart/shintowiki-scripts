#!/usr/bin/env python3
"""generate_shikinaisha_pages_v10.py
================================================
Generate standardized shrine pages for Wikidata-generated Shikinaisha entries
V10: Add sub-bullet qualifiers to property claims
================================================
...
def format_page_content(page_name, qid, entity):
    ...
    final_content = "<!--generated by generate_shikinaisha_pages_v10.py-->\n" + "\n".join(content_parts)
...
def main():
    ...
    print("Generating standardized Shikinaisha pages (V10 - with qualifier sub-bullets)\n")
    print("=" * 60)
    ...
    for idx, page in enumerate(members, 1):
        try:
            ...
            # Save the page
            try:
                page.edit(new_content, summary="Bot: Generate standardized Shikinaisha page (V10 - add qualifier sub-bullets to property claims)")
                processed_count += 1
                print(f" ... ✓ Updated")
