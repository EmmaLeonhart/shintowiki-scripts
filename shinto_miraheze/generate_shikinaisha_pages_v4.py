#!/usr/bin/env python3
"""generate_shikinaisha_pages_v4.py
================================================
Generate standardized shrine pages for Wikidata-generated Shikinaisha entries
V4: Proper province extraction from P361, correct intro text format
================================================
...
def format_page_content(page_name, qid, entity):
    ...
    intro += " is a [[shinto shrine]] in the {{{{ill|Engishiki Jinmyōchō|zh|延喜式神名帳|ja|延喜式神名帳}}}}."
    ...
    # Add sections for ALL properties
...
def main():
    ...
    print("Generating standardized Shikinaisha pages (V4 - with province extraction)\n")
    print("=" * 60)
    ...
    for idx, page in enumerate(members, 1):
        try:
            ...
            # Save the page
            try:
                page.edit(new_content, summary="Bot: Generate standardized Shikinaisha page (V4 - upgraded script with proper province extraction and intro text)")
                processed_count += 1
                print(f" ... ✓ Updated")
