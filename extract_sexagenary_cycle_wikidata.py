"""extract_sexagenary_cycle_wikidata.py
================================================
Extract Wikidata QIDs for all members of [[Category:Sexagenary cycle members]]
================================================
...
def main():
    """Extract Wikidata for all Sexagenary cycle members."""

    print("Extracting Wikidata QIDs for Sexagenary cycle members\n")
    print("=" * 60)
    ...
    # Write to CSV
    csv_filename = 'sexagenary_cycle_members_wikidata.csv'
    print(f"\n{'=' * 60}")
