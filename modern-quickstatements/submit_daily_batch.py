...
ATOMIC_FILES = [
    ...
    "temple_en_labels.txt",                    # Temples: en labels (Len) "<Stem>-<suffix> Temple" deterministically built from kana for Japanese Buddhist temples (generate_temple_en_labels.py); no LLM
