...
# Was 2026-08-08 ("a week into August"). Moved to 2026-07-01 by Emma on
# 2026-07-21: "he did one edit … he's not the threat that we think he is."
# The date is in the past, so the routine edit-rate pause no longer holds the
# drip at all. The infrastructure is deliberately kept — the three attention
# signals below still override this cap, which is the part that matters.
HARD_RESUME = datetime.date(2026, 7, 1)
